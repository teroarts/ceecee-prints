    ...
    <footer className="border-t border-border/70 bg-background">
      <div className="mx-auto grid max-w-6xl gap-10 px-4 py-14 sm:grid-cols-2 sm:px-6 lg:grid-cols-4">
        <div className="space-y-3">
          ...
          <p className="max-w-xs text-sm text-muted-foreground">
            Small-batch apparel and everyday carry, built for the long way round.
          </p>
        </div>
        ...
        <div>
          <h3 className="mb-3 text-sm font-semibold">The Long Way, our newsletter</h3>
          <p className="text-sm text-muted-foreground">
            New drops and restock notes, once a month. No noise.
          </p>
        </div>
      </div>
      ...
      <div className="border-t border-border/70">
        <div className="mx-auto flex max-w-6xl flex-col items-start justify-between gap-2 px-4 py-5 text-sm text-muted-foreground sm:flex-row sm:px-6">
          <p>© {new Date().getFullYear()} Northline Supply Co.</p>
